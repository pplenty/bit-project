...
//				'border' : 'red solid 2px',
	...
	// 바탕(.canvas) 이벤트 등록
	$('.canvas').on('mousedown', '.canvas', function(event) {
...
//	    console.log($(targetIdSelector));
		...
		$(document).on('mousemove', '.sl-block-content', function(event) {
	...
	$(document).on('mousedown', 'body > div.canvas > div > div > div[data-direction=se]', function(event){
